...
cc_create_header( const uint32_t xid, const uint8_t type, const uint16_t length ) {
  ...
  struct ofp_header *header = malloc(sizeof(length));
  if(header== NULL)
  {
...
buffer *
cc_create_error(const uint32_t xid, const uint16_t type, const uint16_t code, const buffer* data)
{
	...
	buf = cc_create_header(xid, OFPT_ERROR, len);

	error_msg = (struct ofp_error_msg *)buf->data;
...
buffer*
cc_create_hello(const uint32_t xid)
{
...
*/
buffer*
cc_create_echo_request(const uint32_t xid, const buffer* buf)
{
	int data_length = 0;
...
buffer*
cc_create_echo_reply(const uint32_t xid, const buffer* buf)
{
	int data_length = 0;
	if ( ( buf!= NULL ) && ( buf->length > 0 ) ) {
		data_length = ( uint16_t ) buf->length;
...
cc_create_vendor( const uint32_t transaction_id, const uint32_t vendor, const buffer *data ) {
  ...
  buf = cc_create_header( transaction_id, OFPT_VENDOR, length );
  //assert( buffer != NULL );

  vendor_header = (struct ofp_vendor_header *) buf->data;
  vendor_header->vendor = htonl( vendor );

  if ( data_length > 0 ) {
    d = ( void * ) ( ( char * ) buf->data + sizeof( struct ofp_vendor_header ) );
...
cc_create_features_request( const uint32_t transaction_id ) {
	struct ofp_header *ofp;
  	buffer *buf;
 	buf = cc_create_header( transaction_id, OFPT_FEATURES_REQUEST, sizeof( struct ofp_header ) );
    ofp = (struct ofp_header *)buf->data;
    printf("type is %d, %s\n", ofp->type, __func__);
...
cc_create_features_reply( const uint32_t transaction_id, const uint64_t datapath_id,
  ...
  buf = cc_create_header( transaction_id, OFPT_FEATURES_REPLY,
                          ( uint16_t ) ( offsetof( struct ofp_switch_features, ports )
                                         + sizeof( struct ofp_phy_port ) * n_ports ) );
  //assert( buffer != NULL );

  switch_features = ( struct ofp_switch_features * ) buf->data;
  ...
  if ( n_ports ) {
    phy_port = ( struct ofp_phy_port * ) ( ( char * ) buf->data
...
cc_create_get_config_reply( const uint32_t transaction_id, const uint16_t flags,
  ...
  buf = cc_create_header( transaction_id, OFPT_GET_CONFIG_REPLY, sizeof( struct ofp_switch_config ) );
  //assert( buffer != NULL );

  switch_config = ( struct ofp_switch_config * ) buf->data;
...
cc_create_packet_in( const uint32_t transaction_id, const uint32_t buffer_id, const uint16_t total_len,
  ...
  buf = cc_create_header( transaction_id, OFPT_PACKET_IN,
                          ( uint16_t ) ( offsetof( struct ofp_packet_in, data ) + data_length ) );
  //assert( buffer != NULL );

  packet_in = ( struct ofp_packet_in * ) buf->data;
...
cc_create_flow_removed( const uint32_t transaction_id, const struct ofp_match match,
  ...
  */
  ...
  buf = cc_create_header( transaction_id, OFPT_FLOW_REMOVED, sizeof( struct ofp_flow_removed ) );
  //assert( buffer != NULL );

  flow_removed = ( struct ofp_flow_removed * ) buf->data;
...
cc_create_port_status( const uint32_t transaction_id, const uint8_t reason,
  ...
  buf = cc_create_header( transaction_id, OFPT_PORT_STATUS, sizeof( struct ofp_port_status ) );
  //assert( buffer != NULL );

  port_status = ( struct ofp_port_status * ) buf->data;
...
cc_create_packet_out( const uint32_t transaction_id, const uint32_t buffer_id, const uint16_t in_port,
  ...
  buf = cc_create_header( transaction_id, OFPT_PACKET_OUT, length );
  //assert( buffer != NULL );

  packet_out = ( struct ofp_packet_out * ) buf->data;
  packet_out->buffer_id = htonl( buffer_id );
  packet_out->in_port = htons( in_port );
  packet_out->actions_len = htons( actions_length );

  if ( actions_length > 0 ) {
    a = ( void * ) ( ( char * ) buf->data + offsetof( struct ofp_packet_out, actions ) );
...
cc_create_flow_mod( const uint32_t transaction_id, const struct ofp_match match,
  ...
  */
  ...
  buf = cc_create_header( transaction_id, OFPT_FLOW_MOD, length );
  //assert( buffer != NULL );
  ...
  if ( actions_length > 0 ) {
    a = ( void * ) ( ( char * ) buf->data + offsetof( struct ofp_flow_mod, actions ) );
...
cc_create_port_mod( const uint32_t transaction_id, const uint16_t port_no,
  ...
  buf = cc_create_header( transaction_id, OFPT_PORT_MOD, sizeof( struct ofp_port_mod ) );

  port_mod = ( struct ofp_port_mod * ) buf->data;
...
cc_create_stats_request( const uint32_t transaction_id, const uint16_t type,
  ...
  buf = cc_create_header( transaction_id, OFPT_STATS_REQUEST, length );
  //assert( buffer != NULL );

  stats_request = ( struct ofp_stats_request * ) buf->data;
...
cc_create_flow_stats_request( const uint32_t transaction_id, const uint16_t flags,
  ...
  */
  ...
  buf = cc_create_stats_request( transaction_id, OFPST_FLOW, length, flags );
  //assert( buffer != NULL );

  flow_stats_request = ( struct ofp_flow_stats_request * ) ( ( char * ) buf->data
...
cc_create_aggregate_stats_request( const uint32_t transaction_id,
  ...
  */
  ...
  buf = cc_create_stats_request( transaction_id, OFPST_AGGREGATE, length, flags );
  //assert( buffer != NULL );

  aggregate_stats_request = ( struct ofp_aggregate_stats_request * ) ( ( char * ) buf->data
                            + offsetof( struct ofp_stats_request, body ) );
...
cc_create_port_stats_request( const uint32_t transaction_id, const uint16_t flags,
  ...
  buf = cc_create_stats_request( transaction_id, OFPST_PORT, length, flags );
  //assert( buffer != NULL );

  port_stats_request = ( struct ofp_port_stats_request * ) ( ( char * ) buf->data
                       + offsetof( struct ofp_stats_request, body ) );
...
cc_create_queue_stats_request( const uint32_t transaction_id, const uint16_t flags,
  ...
  buf = cc_create_stats_request( transaction_id, OFPST_QUEUE, length, flags );
  //assert( buffer != NULL );

  queue_stats_request = ( struct ofp_queue_stats_request * ) ( ( char * ) buf->data
                        + offsetof( struct ofp_stats_request, body ) );
...
cc_create_vendor_stats_request( const uint32_t transaction_id, const uint16_t flags,
  ...
  length = ( uint16_t ) ( offsetof( struct ofp_stats_request, body ) + sizeof( uint32_t )
                        + data_length );
  buf = cc_create_stats_request( transaction_id, OFPST_VENDOR, length, flags );
  //assert( buffer != NULL );

  v = ( uint32_t * ) ( ( char * ) buf->data + offsetof( struct ofp_stats_request, body ) );
  *v = htonl( vendor );

  if ( data_length > 0 ) {
    b = ( void * ) ( ( char * ) buf->data
...
cc_create_stats_reply( const uint32_t transaction_id, const uint16_t type,
  ...
  buf = cc_create_header( transaction_id, OFPT_STATS_REPLY, length );
  //assert( buffer != NULL );

  stats_reply = ( struct ofp_stats_reply * ) buf->data;
...
cc_create_desc_stats_reply( const uint32_t transaction_id, const uint16_t flags,
  ...
  buf = cc_create_stats_reply( transaction_id, OFPST_DESC, length, flags );
  //assert( buffer != NULL );
...
cc_create_flow_stats_reply( const uint32_t transaction_id, const uint16_t flags,
  ...
  buf = cc_create_stats_reply( transaction_id, OFPST_FLOW, length, flags );
  //assert( buffer != NULL );
...
cc_create_aggregate_stats_reply( const uint32_t transaction_id, const uint16_t flags,
  ...
  buf = cc_create_stats_reply( transaction_id, OFPST_AGGREGATE, length, flags );
  //assert( buffer != NULL );
...
cc_create_table_stats_reply( const uint32_t transaction_id, const uint16_t flags,
  ...
  buf = cc_create_stats_reply( transaction_id, OFPST_TABLE, length, flags );
  //assert( buffer != NULL );
...
cc_create_port_stats_reply( const uint32_t transaction_id, const uint16_t flags,
  ...
  buf = cc_create_stats_reply( transaction_id, OFPST_PORT, length, flags );
  //assert( buffer != NULL );
...
cc_create_queue_stats_reply( const uint32_t transaction_id, const uint16_t flags,
  ...
  buf = cc_create_stats_reply( transaction_id, OFPST_QUEUE, length, flags );
  //assert( buffer != NULL );
...
cc_create_vendor_stats_reply( const uint32_t transaction_id, const uint16_t flags,
  ...
  buf = cc_create_stats_reply( transaction_id, OFPST_VENDOR, length, flags );
  //assert( buffer != NULL );
...
cc_create_queue_get_config_request( const uint32_t transaction_id, const uint16_t port ) {
  ...
  buf = cc_create_header( transaction_id, OFPT_QUEUE_GET_CONFIG_REQUEST,
                          sizeof( struct ofp_queue_get_config_request ) );
  //assert( buffer != NULL );

  queue_get_config_request = ( struct ofp_queue_get_config_request * ) buf->data;
...
cc_create_queue_get_config_reply( const uint32_t transaction_id, const uint16_t port,
  ...
  buf = cc_create_header( transaction_id, OFPT_QUEUE_GET_CONFIG_REPLY, length );
  //assert( buffer != NULL );

  queue_get_config_reply = ( struct ofp_queue_get_config_reply * ) buf->data;
