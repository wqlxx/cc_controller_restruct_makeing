 ...
 * @return CC_E_NONE on success; CC_E_ERR otherwise.
 */
uint32_t
 ...
 * function which should return CC_E_NONE when the desired element is found.
 *
 * @param head the head of the list.
 * @param function the function to call for each element. It should return CC_E_NONE when the desired element is found.
